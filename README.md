...
This repository hold the code base for the agent based model framework implemented in python/pygame to model and simulate agents collectively foraging in the environment.
